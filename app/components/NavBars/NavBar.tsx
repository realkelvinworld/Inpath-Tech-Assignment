...
export default function Navbar() {
  ...
  const handleOrientationChange = () => {
    if (window.innerWidth > window.innerHeight) {
      ...
      // Handle portrait mode if needed
    }
  };
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      window.removeEventListener("resize", handleOrientationChange); // Cleanup listener
    };
  }, []);
                      ...
                      {Navlinks.map((data, i) => {
                        ...
                        return (
                          <motion.div
                            ...
                            className="w-full py-5 text-center text-2xl hover:opacity-60"
                          >
                            <Link
                              href={link}
                              onClick={hideMenu}
